...
<ol>
    <li><h4 class="white">What Does the Data Say vs. What Do We Conclude?</h4></li>
    <li><h4 class="white">Finding Patterns, Trends &amp; Outliers</h4></li>
    <li><h4 class="white">Correlation, Regression &amp; Causation</h4></li>
    <li><h4 class="white">Team Analysis &amp; Instructor Conferences</h4></li>
    <li><h4 class="white">Scientific Storytelling: Results Sentences</h4></li>
</ol>
...
.font85[
<div class="chev-row-sm"><div class="chev-sm">1</div><div class="chev-text"><strong>Session 9 Mission Sheet (RcF):</strong> visualize one variable, compare two variables, identify outliers, write one key insight.</div></div>
<div class="chev-row-sm"><div class="chev-sm">2</div><div class="chev-text"><strong>Session 9 Mission Sheet (RcS):</strong> variable-pair analysis, compute the correlation coefficient, write a 2-sentence interpretation, identify one causal limitation.</div></div>
<div class="chev-row-sm"><div class="chev-sm">3</div><div class="chev-text">Create <strong>2&ndash;3 publication-quality charts</strong> for your Results slides &mdash; clean axes, titles, colorblind-friendly palette, source caption.</div></div>
]

--

.content-box-green[
.font88[**`r fontawesome::fa("flag-checkered", fill = "#009E73")` Team output due before dinner:** final analysis charts exported as PNG + both mission sheets complete.]
]
...
- **Individual:** write a **3&ndash;5 sentence results paragraph** summarizing your key finding in plain language. Read it aloud &mdash; does it make sense **without** the chart?
...
- Add **captions**.
- Make sure the slide **text adds interpretation** &mdash; not just a repeat of what the chart shows.
]
]]
